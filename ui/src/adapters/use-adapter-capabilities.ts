...
const KNOWN_DEFAULTS: Record<string, AdapterCapabilities> = {
  ...
  ironclaw_http: { supportsInstructionsBundle: true, supportsSkills: false, supportsLocalAgentJwt: true, requiresMaterializedRuntimeSkills: false, supportsModelProfiles: false },
